...
using BuildingBlocks.SharedKernel.Metrics;
using MediatR;
using Microsoft.Extensions.Logging;

namespace BuildingBlocks.SharedKernel.Pipelines;

public sealed class MetricsBehavior<TRequest, TResponse>(IRequestHandler<TRequest, TResponse> requestHandler,
    ...
    where TResponse : notnull
{
                                        ...
                                        CancellationToken cancellationToken)
    {
        ...
        var isQuery = query.EndsWith(nameof(query), StringComparison.OrdinalIgnoreCase);
