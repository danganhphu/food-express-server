...
{
    public static IHttpClientBuilder AddGrpcServiceReference<TClient>(this IServiceCollection services,
                                                                      string address,
    ...
    private static void AddGrpcHealthChecks(IServiceCollection services,
                                            Uri uri,
