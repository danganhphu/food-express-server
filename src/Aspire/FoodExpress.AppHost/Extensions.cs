...
public static class Extensions
{
    ...
    public static void AddAi(this IDistributedApplicationBuilder builder,
                             List<IResourceBuilder<ProjectResource>?> resources)
    {
        ...
        var embeddings = ollama.AddModel(Ollama.Embedding, "nomic-embed-text:latest");

        var chat = ollama.AddModel(Ollama.Chat, "deepseek-r1:1.5b");
    ...
    public static void ConfigureEmailProvider(this IDistributedApplicationBuilder builder,
    ...
    public static void ConfigAzureResource(this IDistributedApplicationBuilder builder,
                                           ...
                                           IResourceBuilder<AzureSignalRResource> signalR)
    {
        ...
        cosmos.AddCosmosDatabase(ServiceName.Rating).AddContainer("Feedbacks", "/id");
        ...
        cosmos.ConfigureInfrastructure(
            infra =>
            {
                ...
                cosmosDbAccount.Tags.Add("Project", nameof(FoodExpress));
            });

        storage.ConfigureInfrastructure(
            infra =>
            {
                ...
                storageAccount.Tags.Add("Project", nameof(FoodExpress));
            });
    }
}
